...
"values('"+KH.getMaLoaiKH()+"','"+KH.getTenKhachHang()+"','"+KH.getDiaChi()+"',"
        ...
        public static void SuaKhachHangTheoMa(KhachHangDTO KH){
            String cauTruyVan = "update KhachHang set MaLoaiKH =" + KH.getMaLoaiKH() + ",TenKH = N'"+ KH.getTenKhachHang() +"',DiaChi = N'"+ KH.getDiaChi() +"',GioiTinh = " + KH.getGioitinh() + ",SoDienThoai = '" + KH.getSDT() + "',LoaiKH = N'" + KH.getLoaiKH() + "' where MaKH = " + KH.getMaKH();
